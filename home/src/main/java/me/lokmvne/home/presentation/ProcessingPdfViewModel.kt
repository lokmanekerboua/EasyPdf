...
import me.lokmvne.home.data.models.request.File as MYfILE

@HiltViewModel
class ProcessingPdfViewModel @Inject constructor(
    ...
    val filePath = mutableStateOf<String?>("File not selected")


    fun Start(tool: String) {
...
//-----------------------------------------------authenticate----------------------------------------------------
            ...
            when (tokenres) {
                ...
                is Resource.Success -> {
//--------------------------------------------------start---------------------------------------------------------
                    val res = apiRepository.Start(tool, tokenres.data!!.token)
                    when (res) {
                        is Resource.Error -> {
